...
//
// LESSONS APPLIED:
// - No plain 'paragraph' block duplicating an 'internal-link' sentence.
// - 'internal-link' used ONLY for links to other articles (has articleSlug).
// - 'calculator-cta' used ONLY for calculator mentions (prefix/suffix only, no articleSlug).
// - Bolt: verify the exact export name against the real import in EducationPage.tsx
//   BEFORE writing the file — do not guess.
// - Replace the entire contents of
//   src/content/what-is-cosmos-atom-staking-beginner-guide-2026.ts with this array.
// - Do NOT shorten, condense, or drop any section.
// - After inserting, run npm run build:prerender, report word count, and confirm
//   zero duplicate paragraphs before considering this done. A screenshot or visual
//   check is more reliable than copy-pasted text for verifying internal-link rendering.

import { ContentBlock } from '../types';

export const whatIsCosmosAtomStakingBeginnerGuide2026: ContentBlock[] = [
  {
    type: 'intro',
