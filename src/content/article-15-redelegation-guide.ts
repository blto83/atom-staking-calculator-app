// New article: how-to-redelegate-atom-switch-validators-without-losing-rewards
...
// src/content/how-to-redelegate-atom-switch-validators-without-losing-rewards.ts
// Wire EducationPage.tsx via ArticleBody. Run npm run build:prerender, confirm
// 16 total pages validate, report word count, confirm zero duplicate paragraphs.
