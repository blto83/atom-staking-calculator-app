// New article: atom-staking-scenarios-100-1000-10000-atom-rewards
// Category: Portfolio Growth
// Format matches the exact ContentBlock schema from src/types.ts.
// TARGET: 2,500-3,000 actual rendered words (same target as the tax guide article).
// Written intentionally long since actual counts consistently render lower than drafts.
//
...
// src/content/atom-staking-scenarios-100-1000-10000-atom-rewards.ts
// Wire EducationPage.tsx via ArticleBody. Run npm run build:prerender.
//
// WORD COUNT REQUIREMENT: This content must render at 2,500-3,000 actual words
// as counted across all text fields (paragraphs, headings, callouts, table cells,
// bullet items, FAQ, key takeaways, internal-link and calculator-cta text). Do NOT
// shorten, condense, or paraphrase any section to fit a different length. If your
// word count comes in under 2,500 words, report the exact count and STOP — do not
// pad content to compensate. I will provide additional content to reach target
// rather than have you generate filler text.
