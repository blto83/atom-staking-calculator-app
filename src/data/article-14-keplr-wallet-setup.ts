// New article: how-to-set-up-keplr-wallet-for-atom-staking-2026
// Category: Beginner Guides
// Format matches the exact ContentBlock schema from src/types.ts (confirmed field names).
//
...
// featured: false
//
// Bolt: verify the exact export name against the real import pattern used in
// EducationPage.tsx for existing articles before naming it — do not guess.
// Insert the metadata object into src/data/articles.ts (append to array, don't
// re-read/re-print other articles). Create this content file at
// src/content/how-to-set-up-keplr-wallet-for-atom-staking-2026.ts
// Wire EducationPage.tsx to render this article via ArticleBody.
// Run npm run build:prerender, confirm 15 total pages validate, report word count.
